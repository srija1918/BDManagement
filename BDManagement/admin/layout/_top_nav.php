        ...
        <div class="row">
            <div class="col-md-4">
                <div class="logo-left-15 pull-left">
                    <div class="h4" id="logo"><a href="index.php">Blood Bank Management</a></div>
                </div>
            </div>
            ...
            <div class="col-md-4">
                <div class="pull-right">
                    <ul class="nav nav-pills">
                        ...
                        <li class="<?php if (isset($setCreateCampaignActive)) { echo $setCreateCampaignActive; } else { echo '';}?>"><a href="CreateCampaign.php">campaign</a></li>
