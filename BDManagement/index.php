...
<div class="row">
    <div class="col-md-6">
        ...
        <div class="panel panel-default">
            <div class="panel-heading">
                <div class="col-md-6">
                    <img src="assets/login1.png" class="img img-responsive img-thumbnail">
                </div>
            ...
            <div class="panel-body">
                <form class="form-vertical" role="form" method="post" action="index.php">
                    ...
                    <div class="form-group loginBtn">
                        ...
                        <a href="users/" class="btn btn-sm btn-warning">Request blood</a>
                        <A href="mailto:abc@gmail.com" class="btn btn-sm btn-warning" >Forgot Password</A>
                    </div>
                </form>
            </div>
			</div>
    ...
    <div class="col-md-4">
        <img src="assets/blood.png" class="img img-responsive">
    </div>
</div>
