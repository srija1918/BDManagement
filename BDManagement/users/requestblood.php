...
if (isset($_POST['submitBtn'])) {
    ...
    $db = new DBConnect();
    $flag = $db->requestUser($firstName, $lastName, $email, $dob, $gender, $bType, $address, $city, $mobile);
    ...
    <div class="col-md-6">
        ...
        <div class="panel panel-default">
            <div class="panel-heading">
                ...
                <h2><center>RequestForm</center></h2>               
            </div>
            <div class="panel-body">
                <form method="post" action="requestblood.php" class="form-horizontal">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-8">
                            <button class="btn btn-success" name="submitBtn" >Request</button>
                        </div>
                    </div>
                </form>
            </div>
